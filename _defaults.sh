...
export DEFAULT_DOCKER_IMAGE=${DEFAULT_DOCKER_IMAGE:-alpine:3.20}
export DEFAULT_DOCKER_BUILDTIME_GO_IMAGE=${DEFAULT_DOCKER_BUILDTIME_GO_IMAGE:-golang:alpine3.20}
...
export LIGHTNING_CONFIGURE_OPTS=${LIGHTNING_CONFIGURE_OPTS:-"--enable-debugbuild --developer"}
